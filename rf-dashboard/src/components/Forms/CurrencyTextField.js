...
class CurrencyTextField extends React.Component {
  ...
  componentDidMount() {
    ...
    this.autonumeric = new AutoNumeric(this.input, this.props.defaultValue ? this.props.defaultValue : this.props.value, {
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (this.props.input.value !== "") {
      if (!newProps.value && newProps.value !== undefined) {
        return
      } else if (newProps.value !== "" && newProps.value !== undefined) {
        return
      ...
      this.autonumeric.set(this.props.input.value)
