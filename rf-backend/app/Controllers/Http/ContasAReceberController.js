...
class ContasAReceberController {
  ...
  /**
   * Render a form to be used for creating a new contasareceber.
   * GET contasarecebers/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing contasareceber.
   * GET contasarecebers/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
